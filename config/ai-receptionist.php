...
return [
    ...
    */
    'booking' => [
        ...
        // Multiple bookings
        'allow_multiple_bookings' => env( 'BOOKING_ALLOW_MULTIPLE', false ),

        // Limits
        'max_bookings_per_day' => env( 'BOOKING_MAX_PER_DAY', 5 ),
        'max_cancellations_per_day' => env( 'BOOKING_MAX_CANCELLATIONS', 3 ),
        'cancellation_cooldown_minutes' => env( 'BOOKING_CANCELLATION_COOLDOWN', 5 ),
    ],
